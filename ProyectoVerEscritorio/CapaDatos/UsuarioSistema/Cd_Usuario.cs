    ...
    public class Cd_Usuario
    {
        ...
        public List<Ce_Usuario> ConsultarUsuario()
        {
            ...
            using (SqlConnection conex = new(Cd_Conexion._rutaBaseDatos))
            {
                    ...
                    using (SqlCommand cmd = new("SP_ConsultarUsuario", conex))
                    {
                        ...
                        while (leer.Read())
                        {
                            Ce_Usuario DatosUsuarios = new()
                            {
                                ...
                                IdRol = leer.GetInt32(4),
                                EstadoUsuario = leer.GetBoolean(5)
                            };
                ...
                {
                    Console.WriteLine("Ocurrio un error. ._. " + ex.Message);
                }
            }
        ...
        public async Task<string> EnviarCorreoRecuperacion(string userRequesting, string nuevaContrasenia, string ContraseniaNuevaEncriptada)
        {
            using (SqlConnection conex = new SqlConnection(Cd_Conexion._rutaBaseDatos))
            {
                ...
                using (SqlCommand command = new SqlCommand("SP_RecuperarContrasenia", conex))
                {
                    ...
                    command.Parameters.AddWithValue("@Contrasenia", ContraseniaNuevaEncriptada);
